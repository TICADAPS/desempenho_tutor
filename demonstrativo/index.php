                            ...
                            <div class="modal fad modaldp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered mw-100 w-75">
                                    <div class="modal-content">
                                        <div class="modal-header bg-light">
                                            <div class="col-10 mt-1">
                                                <h5 class="modal-title text-left text-primary" id="exampleModalLabel"><i class="fas fa-poll"></i>&nbsp; Deixou de alcançar</h5>
                                            </div>
                                            <div class="col-2">
                                                <button type="button" class="bg-light close" data-dismiss="modal" aria-label="close">
                                                    <span aria-hidden="true">&times;</span> </button>
                                                        ...
                                                        <div class="col-sm-12 pr-2 pl-2">
                                                            ...
                                                            if($faltamtext > 0){
                                                                ...
                                                                if($qand < 50){
                                                                    ...
                                                                    $reqand = str_replace(".", ",", $reqand);
                                                                    echo "<i class='fas fa-asterisk text-danger'></i>&nbsp; <label class='text-primary'>Qualidade assistencial:</label>&nbsp; <label class='text-dark'>$qandtext de 50</label>&nbsp; <i class='fas fa-arrow-right text-info'></i>&nbsp; os $reqand que faltam estão assim distribuídos:<br>";
                                                                    ?>
                                                            <h6 class="font-weight-bold ml-4 mt-2">Indicadores que não atingiram o limite superior (10 pontos):</h6>
                                                                <ul class="ml-2">
                                                                    <?php if($rpc < 10){ ?>
                                                                    <li>Pré-Natal (Consultas): <?= $rpctxt2 ?> &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; n1 = (<label class="text-primary"><?= $rpctxt2 ?></label>/45)*10 &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; <label class="text-dark">n1 = <?= $rpctxt ?></label> &nbsp;(faltam <label class="text-danger"><?php echo (10 - $rpc); ?></label> para chegar a 10 pontos).</li>
                                                                    <?php } ?>
                                                                    <?php if($rph < 10){ ?>
                                                                    <li>Pré-Natal (Exames): <?= $rphtxt2 ?> &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; n2 = (<label class="text-primary"><?= $rphtxt2 ?></label>/60)*10 &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; <label class="text-dark">n2 = <?= $rphtxt ?></label> &nbsp;(faltam <label class="text-danger"><?php echo (10 - $rph); ?></label> para chegar a 10 pontos).</li>
                                                                    <?php } ?>
                                                                    <?php if($rcc < 10){ ?>
                                                                    <li>Cobertura Citopatológico: <?= $rcctxt2 ?> &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; n3 = (<label class="text-primary"><?= $rcctxt2 ?></label>/40)*10 &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; <label class="text-dark">n3 = <?= $rcctxt ?></label> &nbsp;(faltam <label class="text-danger"><?php echo (10 - $rcc); ?></label> para chegar a 10 pontos).</li>
                                                                    <?php } ?>
                                                                    <?php if($rh < 10){ ?>
                                                                    <li>Hipertensão (PA Aferida): <?= $rhtxt2 ?> &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; n4 = (<label class="text-primary"><?= $rhtxt2 ?></label>/50)*10 &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; <label class="text-dark">n4 = <?= $rhtxt ?></label> &nbsp;(faltam <label class="text-danger"><?php echo (10 - $rh); ?></label> para chegar a 10 pontos).</li>
                                                                    <?php } ?>
                                                                    <?php if($rd < 10){ ?>
                                                                    <li>Diabetes (Hemoglobina Glicada): <?= $rdtxt2 ?> &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; n5 = (<label class="text-primary"><?= $rdtxt2 ?></label>/50)*10 &nbsp;<i class='fas fa-arrow-right text-info'></i>&nbsp; <label class="text-dark">n5 = <?= $rdtxt ?></label> &nbsp;(faltam <label class="text-danger"><?php echo (10 - $rd); ?></label> para chegar a 10 pontos).</li>
                                                                    <?php } ?>
                                                                </ul>
                                                            <?php    }
                                                                if($cpossui < 30){
                                                                    ...
                                                                    $rcpossui = str_replace(".", ",", $rcpossui);
                                                                    echo "<i class='fas fa-asterisk text-danger'></i>&nbsp; <label class='text-primary'>Competências profissionais:</label>&nbsp; <label class='text-dark'>$cpossuitext de 30</label>&nbsp; <i class='fas fa-arrow-right text-info'></i>&nbsp; Não realizou a autoavaliação.<br>";
                                                                }
                                                                if($anota < 10){
                                                                    ...
                                                                    $ranota = str_replace(".", ",", $ranota);
                                                                    if($anota > 0){
                                                                        echo "<i class='fas fa-asterisk text-danger'></i>&nbsp; <label class='text-primary'>Aperfeiçoamento profissional:</label>&nbsp; <label class='text-dark'>$anotatext de 10</label>&nbsp; <i class='fas fa-arrow-right text-info'></i>&nbsp; Os certificados de cursos realizados apresentados no período da avaliação não foram suficientes para alcançar o limite previsto no programa de avaliação.<br>";
                                                                    }else{
                                                                        echo "<i class='fas fa-asterisk text-danger'></i>&nbsp; <label class='text-primary'>Aperfeiçoamento profissional:</label>&nbsp; <label class='text-dark'>$anotatext de 10</label>&nbsp; <i class='fas fa-arrow-right text-info'></i>&nbsp; Não apresentou pontuação suficiente referente ao domínio.<br>";
                                                                    }
                                                                }
                                                                if($qnota < 10){
                                                                    ...
                                                                    $rqt = str_replace(",", "", $rqt);
                                                                    $rqt = str_replace(".", ",", $rqt);
                                                                    echo "<i class='fas fa-asterisk text-danger'></i>&nbsp; <label class='text-primary'>Qualidade da tutoria:</label>&nbsp; <label class='text-dark'>$qnotatext de 10</label>&nbsp; <i class='fas fa-arrow-right text-info'></i>&nbsp; faltam $rqt para completar o limite previsto de 10 pontos.<br>";
                                                                }
                                                            }
                                                            ?>
                                                        </div>
