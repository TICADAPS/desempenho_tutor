                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-info">
                                                        <label class="font-weight-bold">IGAD: </label><label> &nbsp;&nbsp;<?= $mftext ?>%</label>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row p-3">
                                                            <div class="col-md-12 mt-3 mb-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <button class="text-center btn btn-warning text-dark border-light shadow-sm rounded form-control" data-toggle="modal" data-target=".modalqt" id="modalqt" style="height: 100px;">Qualidade da<br>tutoria</button> 
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <button class="text-center btn btn-warning text-dark border-light shadow-sm rounded form-control" data-toggle="modal" data-target=".modalap" id="modalap" style="height: 100px;">Aperfeiçoamento<br>profissional</button> 
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="text-center btn btn-warning text-dark border-light shadow-sm rounded form-control" data-toggle="modal" data-target=".modalcp" id="modalcp" style="height: 100px;">Competências<br>profissionais</button> 
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12">
