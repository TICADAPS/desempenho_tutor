            ...
            <div class="row mb-2">
                ...
                <div class="col-md-9 mt-2 mb-2 align-middle">
                    <div class="testeira text-center">
                        ...
                        <div class="testeirabody h5 text-primary">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="row mt-2">
                                                                                    <div class="col-md-12">
                                                                                        <button type="button" data-toggle="modal" data-target=".modaligad" class="btn btn-outline-danger shadow-sm text-info">Mais detalhes...</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                          </div>
