...
$html .= "<p style='text-align: justify;'>Neste primeiro ciclo, você alcançou a Nota Geral <label style='color: red;'>$mftext</label> como resultado da sua Avaliação Individual, referente ao período $descciclo de $ano.</p>";
...
$html .= "      <dd style='text-align: justify;'>Os indicadores têm como unidade de análise o indivíduo e avaliam aspectos do cuidado em saúde dispensado de forma individualizada. É sabido que
