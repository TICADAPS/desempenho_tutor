...
<!--                                <li class="nav-item">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="../../relatorios/relatorioGeralCP.php?a=<?= $ano ?>&c=<?= $ciclo ?>">Relatório Final</a>
                                        <?php } ?>
                                    </div>
                                </li>-->
                                <li class="nav-item">
                    ...
                    <div class="row p-3">
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <button type="button" id="btenvdemonstrativo" class="btn btn-outline-primary shadow-sm border-primary" data-toggle="modal" data-target="#modalEnvDemonstrativo"><b><i class="far fa-file-excel"></i>&nbsp; Relatório Final</b></button>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
