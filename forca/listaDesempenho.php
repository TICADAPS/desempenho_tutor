...
$queryp = mysqli_query($conn, $sqlp) or die(mysqli_error($conn));
$rsp = mysqli_fetch_array($queryp);
$periododesc = '';
if($rsp){
    do{
        $periododesc = $rsp['descricaoperiodo'];
        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-12 col-md-9 mt-5 ">
                    <h4 class="mb-4 font-weight-bold text-center">Unidade de Serviços em Saúde - Programa de Avaliação de Desempenho do Tutor Médico</h4>
                    <h5 class="mb-4 text-center text-primary">Ano: &nbsp;<?= $ano ?> &nbsp;&nbsp;|&nbsp;&nbsp; Ciclo: &nbsp;<?= $ciclo ?>º &nbsp;&nbsp;|&nbsp;&nbsp; Período: &nbsp;<?= $periododesc ?></h5>
                </div>
            </div>
            <div class="row">
