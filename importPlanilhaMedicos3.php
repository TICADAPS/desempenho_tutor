    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="container bg-light mt-4 p-5 mx-auto col-md-8 col-sm-6">
                ...
                <div class="row">
                    <div class="col-12 col-md-8 col-sm-6 mx-auto">
                        <form method="post" enctype="multipart/form-data" action="importPlanilhaMedicosResp3.php">
                            <h5 class="mt-2">Arquivo CSV com colunas na seguinte ordem:</h5>
                            <h6 class="mt-2">1º CPF</h6>
                            <h6 class="mt-2">2º Categoria IVS - Índice de Vulnerabilidade Social</h6>
                    ...
                    <div class="col-12 col-md-8 col-sm-6 mx-auto">
                        ...
                        if($_SESSION['msg']!=""){
                            ...
                            echo "<META HTTP-EQUIV='REFRESH' CONTENT=\"2;
                                URL='importPlanilhaMedicos3.php'\">";
                            $_SESSION['msg']="";
                        }
                        ?>
                    </div>
