        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-sm-6 mt-5 ">
                    <h3 class="mb-4">APERFEIÇOAMENTO PROFISSIONAL - Planilha da Unidade de Serviços em Saúde</h3>
                </div>
            </div>
            <div class="container bg-light mt-4 p-5 mx-auto col-md-8 col-sm-6">
                ...
                <div class="row">
                    <div class="col-12 col-md-8 col-sm-6 mx-auto">
                        <form method="post" enctype="multipart/form-data" action="importPlanilhaMedicosAPResp.php">
                    ...
                    <div class="col-12 col-md-8 col-sm-6 mx-auto">
                        ...
                        if($_SESSION['msg']!=""){
                            ...
                            echo "<META HTTP-EQUIV='REFRESH' CONTENT=\"2;
                                URL='importPlanilhaMedicosAP.php'\">";
                            $_SESSION['msg']="";
                        }
                        ?>
                    </div>
