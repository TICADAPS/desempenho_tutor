...
//                    $hipertensao,$diabetes,2024,24,$datahoje<br>";
            ...
            $sql4 = "select id from competencias_profissionais where cpf = '$cpftratado' and ibge = '$ibge' and cnes = '$cnes' and ine = '$ine' and ano = '$ano' and ciclo = '$ciclo' limit 1";
            $query3 = mysqli_query($conn, $sql4) or die(mysqli_error($conn));
            $nrrs3 = mysqli_num_rows($query3); 
            if($nrrs3 === 0){
                $sql2 = "insert into competencias_profissionais (cpf,ibge,cnes,ine,ano,ciclo) "
                        . "values ('$cpftratado','$ibge','$cnes','$ine','$ano','$ciclo')";
    ...
    header ("Location: importPlanilhaMedicosCP.php");
}
