...
$anoAtual = date('Y');
$sqlQuad = "SELECT d.idperiodo, p.descricaoperiodo FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine
inner join periodo p on p.idperiodo = d.idperiodo where ano = '$anoAtual' group by idperiodo;";
$queryQuad = mysqli_query($conn, $sqlQuad);
$rowsQuad = mysqli_num_rows($queryQuad);
$quadrim = "";
if($rowsQuad > 0){
    if($rowsQuad < 2){
        $quadrim .= "(1º Quadrimestre)";
    }elseif($rowsQuad < 3){
        $quadrim .= "(1º e 2º Quadrimestre)";
    }else{
        $quadrim .= "(1º, 2º e 3º Quadrimestre)";
    }
}
        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-12 col-md-10 mt-5">
                    ...
                    <h4 class="mb-4 text-center">Média dos Indicadores por Região - Ano <?= $anoAtual ?> <?= $quadrim ?></h4>
                </div>
            </div>
            <div class="row">
...
<!--                                <li class="nav-item dropdown">
            ...
            //Região Norte
            $sqlNorteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '1%' and ano = '$anoAtual'";
            $qNorteT = mysqli_query($conn, $sqlNorteT);
            $rowsNorteT = mysqli_num_rows($qNorteT);
            
            $sqlNorte = "SELECT * FROM desempenho where ibge like '1%' and ano = '$anoAtual'";
            ...
            //Região Nordeste
            $sqlNordesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '2%' and ano = '$anoAtual'";
            $qNordesteT = mysqli_query($conn, $sqlNordesteT);
            $rowsNordesteT = mysqli_num_rows($qNordesteT);
            
            $sqlNordeste = "SELECT * FROM `desempenho` where ibge like '2%' and ano = '$anoAtual'";
            ...
            //Região Sudeste
            $sqlSudesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '3%' and ano = '$anoAtual'";
            $qSudesteT = mysqli_query($conn, $sqlSudesteT);
            $rowsSudesteT = mysqli_num_rows($qSudesteT);
            
            $sqlSudeste = "SELECT * FROM `desempenho` where ibge like '3%' and ano = '$anoAtual'";
            ...
            //Região Sul
            $sqlSulT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '4%' and ano = '$anoAtual'";
            $qSulT = mysqli_query($conn, $sqlSulT);
            $rowsSulT = mysqli_num_rows($qSulT);
            
            $sqlSul = "SELECT * FROM `desempenho` where ibge like '4%' and ano = '$anoAtual'";
            ...
            //Região Centro-Oeste
            $sqlCentroT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '5%' and ano = '$anoAtual'";
            $qCentroT = mysqli_query($conn, $sqlCentroT);
            $rowsCentroT = mysqli_num_rows($qCentroT);
            
            $sqlCentro = "SELECT * FROM `desempenho` where ibge like '5%' and ano = '$anoAtual'";
                        ...
                        <div class="row mt-2 pl-2">
                            <div class="col-md-2 shadow rounded mt-3 ml-2 pt-2 pr-3 pl-3">
                                <div class="row mt-2 pl-1">
                                    <div class="col-md-12">
                                        <h6 class="text-dark small font-weight-bold btn-sm">Norte</h6>
                                    </div>
                                </div>
