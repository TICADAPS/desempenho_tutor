...
$sql = "select * from medico m inner join desempenho d on m.cpf = d.cpf and m.ibge = d.ibge"
        . " inner join periodo p on p.idperiodo = d.idperiodo where m.cpf = '$cpftratado' and ano = '$anoAtual' and d.idperiodo = 23";
        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-12 col-md-10 mt-5">
                    ...
                    <h4 class="mb-4 text-center">Média dos Indicadores por Região - 1º Quadrimestre de <?= $anoAtual ?></h4>
                </div>
            </div>
            <div class="row">
...
//                var_dump($prenatal_consultas,$prenatal_sifilis_hiv,$cobertura_citopatologico,$hipertensao,$diabetestext);
            ...
            //Região Norte
            $sqlNorteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '1%' and ano = '$anoAtual' and d.idperiodo = 23";
            $qNorteT = mysqli_query($conn, $sqlNorteT);
            $rowsNorteT = mysqli_num_rows($qNorteT);
            
            //Região Norte
            $sqlNorte = "SELECT * FROM `desempenho` where ibge like '1%' and ano = '$anoAtual' and idperiodo = 23";
            ...
            //Região Nordeste
            $sqlNordesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '2%' and ano = '$anoAtual' and d.idperiodo = 23";
            $qNordesteT = mysqli_query($conn, $sqlNordesteT);
            $rowsNordesteT = mysqli_num_rows($qNordesteT);
            
            //Região Nordeste
            $sqlNordeste = "SELECT * FROM `desempenho` where ibge like '2%' and ano = '$anoAtual' and idperiodo = 23";
            ...
            //Região Sudeste
            $sqlSudesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '3%' and ano = '$anoAtual' and d.idperiodo = 23";
            $qSudesteT = mysqli_query($conn, $sqlSudesteT);
            $rowsSudesteT = mysqli_num_rows($qSudesteT);
            
            //Região Sudeste
            $sqlSudeste = "SELECT * FROM `desempenho` where ibge like '3%' and ano = '$anoAtual' and idperiodo = 23";
            ...
            //Região Sul
            $sqlSulT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '4%' and ano = '$anoAtual' and d.idperiodo = 23";
            $qSulT = mysqli_query($conn, $sqlSulT);
            $rowsSulT = mysqli_num_rows($qSulT);
            
            //Região Sul
            $sqlSul = "SELECT * FROM `desempenho` where ibge like '4%' and ano = '$anoAtual' and idperiodo = 23";
            ...
            //Região Centro-Oeste
            $sqlCentroT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '5%' and ano = '$anoAtual' and d.idperiodo = 23";
            $qCentroT = mysqli_query($conn, $sqlCentroT);
            $rowsCentroT = mysqli_num_rows($qCentroT);
            
            //Região Centro-Oeste
            $sqlCentro = "SELECT * FROM `desempenho` where ibge like '5%' and ano = '$anoAtual' and idperiodo = 23";
