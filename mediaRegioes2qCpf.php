...
$sql = "select * from medico m inner join desempenho d on m.cpf = d.cpf and m.ibge = d.ibge"
        . " inner join periodo p on p.idperiodo = d.idperiodo where m.cpf = '$cpftratado' and ano = '$anoAtual' and d.idperiodo = 24";
        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-12 col-md-10 mt-5">
                    ...
                    <h4 class="mb-4 text-center">Média dos Indicadores por Região - 2º Quadrimestre de <?= $anoAtual ?></h4>
                </div>
            </div>
            <div class="row">
...
<!--                                <li class="nav-item dropdown">
            ...
            if($rscpf === true){
                do {
                    ...
                    $hipertensao = round($rs['hipertensao'],2);
                    $hipertensaotext = str_replace(",", "", $hipertensao);
                    $hipertensaotext = str_replace(".", ",", $hipertensaotext);
                    $diabetes = round($rs['diabetes'],2);
                    $diabetestext = str_replace(",", "", $diabetes);
                    $diabetestext = str_replace(".", ",", $diabetestext);
                } while ($rs = mysqli_fetch_array($query));
//                var_dump($prenatal_consultas,$prenatal_sifilis_hiv,$cobertura_citopatologico,$hipertensao,$diabetestext);
            }
            //média por região
            ...
            //Região Norte
            $sqlNorteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '1%' and ano = '$anoAtual' and d.idperiodo = 24";
            $qNorteT = mysqli_query($conn, $sqlNorteT);
            $rowsNorteT = mysqli_num_rows($qNorteT);
            
            //Região Norte
            $sqlNorte = "SELECT * FROM `desempenho` where ibge like '1%' and ano = '$anoAtual' and idperiodo = 24";
            ...
            //Região Nordeste
            $sqlNordesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '2%' and ano = '$anoAtual' and d.idperiodo = 24";
            $qNordesteT = mysqli_query($conn, $sqlNordesteT);
            $rowsNordesteT = mysqli_num_rows($qNordesteT);
            
            //Região Nordeste
            $sqlNordeste = "SELECT * FROM `desempenho` where ibge like '2%' and ano = '$anoAtual' and idperiodo = 24";
            ...
            //Região Sudeste
            $sqlSudesteT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '3%' and ano = '$anoAtual' and d.idperiodo = 24";
            $qSudesteT = mysqli_query($conn, $sqlSudesteT);
            $rowsSudesteT = mysqli_num_rows($qSudesteT);
            
            //Região Sudeste
            $sqlSudeste = "SELECT * FROM `desempenho` where ibge like '3%' and ano = '$anoAtual' and idperiodo = 24";
            ...
            //Região Sul
            $sqlSulT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '4%' and ano = '$anoAtual' and d.idperiodo = 24";
            $qSulT = mysqli_query($conn, $sqlSulT);
            $rowsSulT = mysqli_num_rows($qSulT);
            
            //Região Sul
            $sqlSul = "SELECT * FROM `desempenho` where ibge like '4%' and ano = '$anoAtual' and idperiodo = 24";
            ...
            //Região Centro-Oeste
            $sqlCentroT = "SELECT * FROM medico m inner join desempenho d on d.cpf = m.cpf and d.ibge = m.ibge and m.cnes = m.cnes and d.ine = m.ine where d.ibge like '5%' and ano = '$anoAtual' and d.idperiodo = 24";
            $qCentroT = mysqli_query($conn, $sqlCentroT);
            $rowsCentroT = mysqli_num_rows($qCentroT);
            
            //Região Centro-Oeste
            $sqlCentro = "SELECT * FROM `desempenho` where ibge like '5%' and ano = '$anoAtual' and idperiodo = 24";
...
<!--        <script src="js/demo/chart-bar-prenatal-1q.js"></script>
        ...
        <script>
            ...
            var regioesPrenatal = new Chart(ctx, {
              type: 'bar',
              data: {
                labels: ["Norte", "Nordeste", "Centro-Oeste", "Sudeste", "Sul","Meu resultado"],
                datasets: [{
                  label: "Proporção",
                  backgroundColor: [
                    ...
                    '<?php if($prenatal_consultas < 18) { echo "#d10e0e"; }elseif($prenatal_consultas < 31){ echo "#e6b20b"; }elseif($prenatal_consultas < 45){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>'],
                  hoverBackgroundColor: [
                    ...
                    '<?php if($prenatal_consultas < 18) { echo "#ba0a0a"; }elseif($prenatal_consultas < 31){ echo "#d2a208"; }elseif($prenatal_consultas < 45){ echo "#15b436"; }else{ echo "#325cd4"; } ?>'],
                  borderColor: "#5c5f68",
                  data: [<?php echo $mediaNortePreCons; ?>,<?php echo $mediaNordestePreCons; ?>,<?php echo $mediaCentroPreCons; ?>,<?php echo $mediaSudestePreCons; ?>,<?php echo $mediaSulPreCons; ?>,<?php echo $prenatal_consultas; ?>]
                }]
              },
              options: {
              ...
              data: {
                ...
                datasets: [{
                  ...
                  backgroundColor: [
                    ...
                    '<?php if($prenatal_sifilis_hiv < 24) { echo "#d10e0e"; }elseif($prenatal_sifilis_hiv < 42){ echo "#e6b20b"; }elseif($prenatal_sifilis_hiv < 60){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>'],
                  hoverBackgroundColor: [
                    ...
                    '<?php if($prenatal_sifilis_hiv < 24) { echo "#ba0a0a"; }elseif($prenatal_sifilis_hiv < 42){ echo "#d2a208"; }elseif($prenatal_sifilis_hiv < 60){ echo "#15b436"; }else{ echo "#325cd4"; } ?>'],
                  borderColor: "#5c5f68",
                  data: [<?php echo $mediaNortePreSif; ?>,<?php echo $mediaNordestePreSif; ?>,<?php echo $mediaCentroPreSif; ?>,<?php echo $mediaSudestePreSif; ?>,<?php echo $mediaSulPreSif; ?>,<?php echo $prenatal_sifilis_hiv; ?>]
                }]
              },
              options: {
                maintainAspectRatio: false,
              ...
              data: {
                ...
                datasets: [{
                  ...
                  backgroundColor: [
                    ...
                    '<?php if($cobertura_citopatologico < 16) { echo "#d10e0e"; }elseif($cobertura_citopatologico < 28){ echo "#e6b20b"; }elseif($cobertura_citopatologico < 40){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>'],
                  hoverBackgroundColor: [
                    ...
                    '<?php if($cobertura_citopatologico < 16) { echo "#ba0a0a"; }elseif($cobertura_citopatologico < 28){ echo "#d2a208"; }elseif($cobertura_citopatologico < 40){ echo "#15b436"; }else{ echo "#325cd4"; } ?>'],
                  borderColor: "#5c5f68",
                  data: [<?php echo $mediaNorteCitop; ?>,<?php echo $mediaNordesteCitop; ?>,<?php echo $mediaCentroCitop; ?>,<?php echo $mediaSudesteCitop; ?>,<?php echo $mediaSulCitop; ?>,<?php echo $cobertura_citopatologico; ?>]
                }]
              },
              options: {
                maintainAspectRatio: false,
              ...
              data: {
                ...
                datasets: [{
                  ...
                  backgroundColor: [
                    ...
                    '<?php if($mediaSulHiper < 20) { echo "#d10e0e"; }elseif($mediaSulHiper < 35){ echo "#e6b20b"; }elseif($mediaSulHiper < 50){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>',
                    '<?php if($hipertensao < 20) { echo "#d10e0e"; }elseif($hipertensao < 35){ echo "#e6b20b"; }elseif($hipertensao < 50){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>'],
                  hoverBackgroundColor: [
                    ...
                    '<?php if($hipertensao < 20) { echo "#ba0a0a"; }elseif($hipertensao < 35){ echo "#d2a208"; }elseif($hipertensao < 50){ echo "#15b436"; }else{ echo "#325cd4"; } ?>'],
                  borderColor: "#5c5f68",
                  data: [<?php echo $mediaNorteHiper; ?>,<?php echo $mediaNordesteHiper; ?>,<?php echo $mediaCentroHiper; ?>,<?php echo $mediaSudesteHiper; ?>,<?php echo $mediaSulHiper; ?>,<?php echo $hipertensao; ?>]
                }]
              },
              options: {
                maintainAspectRatio: false,
              ...
              data: {
                ...
                datasets: [{
                  ...
                  backgroundColor: [
                    ...
                    '<?php if($diabetes < 20) { echo "#d10e0e"; }elseif($diabetes < 35){ echo "#e6b20b"; }elseif($diabetes < 50){ echo "#35cf55"; }else{ echo "#5479e4"; } ?>'],
                  hoverBackgroundColor: [
                    ...
                    '<?php if($diabetes < 20) { echo "#ba0a0a"; }elseif($diabetes < 35){ echo "#d2a208"; }elseif($diabetes < 50){ echo "#15b436"; }else{ echo "#325cd4"; } ?>'],
                  borderColor: "#5c5f68",
                  data: [<?php echo $mediaNorteDiab; ?>,<?php echo $mediaNordesteDiab; ?>,<?php echo $mediaCentroDiab; ?>,<?php echo $mediaSudesteDiab; ?>,<?php echo $mediaSulDiab; ?>,<?php echo $diabetes; ?>]
                }]
              },
              options: {
                maintainAspectRatio: false,
