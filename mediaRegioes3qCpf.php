...
$sql = "select * from medico m inner join desempenho d on m.cpf = d.cpf and m.ibge = d.ibge"
        . " inner join periodo p on p.idperiodo = d.idperiodo where m.cpf = '$cpftratado' and ano = '$anoAtual' and d.idperiodo = 25";
        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-12 col-md-10 mt-5">
                    ...
                    <h4 class="mb-4 text-center">Média dos Indicadores por Região - 3º Quadrimestre de <?= $anoAtual ?></h4>
                </div>
            </div>
            <div class="row">
