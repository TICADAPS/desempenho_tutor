...
class Estado extends Model {
     ...
     * @return null|User
     */
    public function findById(int $id, string $columns = "*"): ?Estado {
        return $this->find("cod_uf = :id", "id={$id}", $columns);
    }
    
   public function findByUF($uf): ?array {
        $allUf = $this->read("SELECT * FROM estado where UF = '$uf'");
     ...
     * @return array|null
     */
    public function allUf(): ?array {
        $allUf = $this->read("SELECT * FROM estado order by UF");
