...
class Email
{
     ...
     * @return Email
     */
    public function bootstrap(string $subject, string $message, string $toEmail, string $toName, string $ccEmail, string $ccName): Email
    {
...
//        $this->data->ccEmail = $ccEmail;
//        $this->data->ccName = $ccName;
...
//        if (!is_email($this->data->ccEmail)) {
//            $this->message->warning("O e-mail de destinatário com cópia não é válido");
//            return false;
//        }
...
//            $this->mail->addCC($this->data->ccEmail , $this->data->ccName);
