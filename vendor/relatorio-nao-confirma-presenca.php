...
where cc.FlagDisponibilidade is null and cc.Edicao = 2
...
where FlagDisponibilidade is null and Edicao = 2;";
$qntd = 0;
...
// Carrega seu HTML
$dompdf->load_html('
<h1 style="text-align: center;">ADAPS - não confirmaram presença de tutoria</h1>
' . $html . '
');
